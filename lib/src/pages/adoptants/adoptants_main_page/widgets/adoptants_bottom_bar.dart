...
class AdoptantsBottomBar extends StatelessWidget {
  const AdoptantsBottomBar({
    Key? key, 
  ...
  final Map<AdoptantsPages, PageItem> pageItems;
          ...
          child: Row(
            ...
            children: [
              _buildItem(
                ...
                title: "Adoption", 
                icon: AUMIcons.cat, 
                action: () => onPageChanged(pageItems[AdoptantsPages.adoption]!)
              ),
              _buildItem(
                context, 
                title: "Favoris", 
              ...
              _buildItem(
                ...
                action: () => onPageChanged(pageItems[AdoptantsPages.dashboard]!)
              ),
            ], 
          ),
        ),
